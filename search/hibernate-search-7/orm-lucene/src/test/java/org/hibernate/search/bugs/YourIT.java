...
public class YourIT extends SearchTestBase {
	...
	// massIndexer = true This works NOT as expected. We fill the database from Scratch and perform a mass index on that database.
	...
	// massIndexer = false This works as expected. We fill the database from Scratch and the different tenants are handled correctly without mass indexing
	@ParameterizedTest
	@ValueSource(booleans =  {true, false})
	public void testYourBug(boolean massIndexer) throws InterruptedException {
